(() => {
  ...
  const categoryGroups = Object.freeze({ Creators: ["Creators", "Attention", "People", "AIMedia"], Property: ["Property", "RealEstate", "Travel"], Interior: ["Interior"], Beauty: ["Beauty"], Health: ["Health"], Sports: ["Sports"], Food: ["Food"], Marketing: ["Marketing", "SEO", "Social", "Sales", "Agencies"], Creative: ["Creative", "Design", "Writing", "Audio", "News"], Professional: ["Professional", "Business", "Careers", "Productivity", "Education"], Finance: ["Finance", "Insurance", "Banking", "Crypto"], Electronics: ["Electronics", "Repair"], Retail: ["Retail", "Ecommerce", "Hardware"], Home: ["Home"], Automotive: ["Automotive", "Auto"], Other: ["Other", "Agents", "Developer", "Security", "Crypto", "Games", "Domains", "Discovery"] });
  ...
  const categoryIcons = Object.freeze({ all: "▦", Creators: "✦", Property: "⌂", Interior: "▤", Beauty: "✿", Health: "✚", Sports: "◐", Food: "◍", Marketing: "↗", Creative: "✎", Professional: "◆", Finance: "◧", Electronics: "▣", Retail: "◇", Home: "⚙", Automotive: "◎", Other: "•••" });
  const translations = {
  ...
  const categoryLabels = { Creators: "Creators & Talent", Property: "Property & Agents", Interior: "Interior & Renovation", Beauty: "Beauty & Aesthetics", Health: "Health & Clinics", Sports: "Sports & Fitness", Food: "Food & Beverage", Marketing: "Marketing & Advertising", Creative: "Creative & Production", Professional: "Professional Services", Finance: "Finance & Insurance", Electronics: "Electronics & Repair", Retail: "Retail & Ecommerce", Home: "Home Services", Automotive: "Automotive", Other: "Other" };
  const categoryTranslations = { Creators: "创作者与艺人", Property: "房产与经纪", Interior: "室内设计与装修", Beauty: "美容与医美", Health: "健康与诊所", Sports: "运动与健身", Food: "餐饮", Marketing: "营销与广告", Creative: "创意与制作", Professional: "专业服务", Finance: "金融与保险", Electronics: "电子与维修", Retail: "零售与电商", Home: "家居服务", Automotive: "汽车", Other: "其他" };
  ...
  function renderCategories() {
    ...
    const shortLabels = state.language === "zh"
      ? { Creators: "创作者", Property: "房产", Interior: "室内装修", Beauty: "美容", Health: "健康诊所", Sports: "运动健身", Food: "餐饮", Marketing: "营销", Creative: "创意制作", Professional: "专业服务", Finance: "金融与保险", Electronics: "电子与维修", Retail: "零售电商", Home: "家居服务", Automotive: "汽车", Other: "其他" }
      : { Creators: "Creators", Property: "Property", Interior: "Interior", Beauty: "Beauty", Health: "Health", Sports: "Sports", Food: "Food", Marketing: "Marketing", Creative: "Creative", Professional: "Professional", Finance: "Finance", Electronics: "Electronics", Retail: "Retail", Home: "Home", Automotive: "Automotive", Other: "Other" };

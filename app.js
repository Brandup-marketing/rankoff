(() => {
  ...
  const categoryIcons = Object.freeze({ all: "▦", Creators: "✦", Property: "⌂", Interior: "▤", Beauty: "✿", Health: "✚", Sports: "◐", Food: "◍", Marketing: "↗", Creative: "✎", Professional: "◆", Retail: "◇", Home: "⚙", Other: "•••" });
  const translations = {
  ...
  function renderCategories() {
    ...
    const shortLabels = state.language === "zh"
      ? { Creators: "创作者", Property: "房产", Interior: "室内装修", Beauty: "美容", Health: "健康诊所", Sports: "运动健身", Food: "餐饮", Marketing: "营销", Creative: "创意制作", Professional: "专业服务", Retail: "零售电商", Home: "家居汽车", Other: "其他" }
      : { Creators: "Creators", Property: "Property", Interior: "Interior", Beauty: "Beauty", Health: "Health", Sports: "Sports", Food: "Food", Marketing: "Marketing", Creative: "Creative", Professional: "Professional", Retail: "Retail", Home: "Home", Other: "Other" };

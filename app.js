(() => {
  ...
  const categoryLabels = { Creators: "Creators & Talent", Property: "Property & Agents", Interior: "Interior & Renovation", Beauty: "Beauty & Wellness", Health: "Health & Clinics", Sports: "Sports & Fitness", Food: "Food & Beverage", Marketing: "Marketing & Advertising", Creative: "Creative & Production", Professional: "Professional Services", Education: "Education & Training", Finance: "Finance & Insurance", Electronics: "Electronics & Repair", Retail: "Retail & Ecommerce", Construction: "Hardware & Construction", Home: "Home Services", Automotive: "Automotive", AI: "AI Tools & Agents", Other: "Other" };
  const categoryTranslations = { Creators: "创作者与艺人", Property: "房产与经纪", Interior: "室内设计与装修", Beauty: "美容与养生", Health: "健康与诊所", Sports: "运动与健身", Food: "餐饮", Marketing: "营销与广告", Creative: "创意与制作", Professional: "专业服务", Education: "教育与培训", Finance: "金融与保险", Electronics: "电子与维修", Retail: "零售与电商", Construction: "五金与建筑", Home: "家居服务", Automotive: "汽车", AI: "AI 工具与智能体", Other: "其他" };
  ...
  function renderCategories() {
    ...
    const shortLabels = state.language === "zh"
      ? { Creators: "创作者", Property: "房产", Interior: "室内装修", Beauty: "美容", Health: "健康诊所", Sports: "运动健身", Food: "餐饮", Marketing: "营销", Creative: "创意制作", Professional: "专业服务", Education: "教育与培训", Finance: "金融与保险", Electronics: "电子与维修", Retail: "零售电商", Construction: "五金建筑", Home: "家居服务", Automotive: "汽车", AI: "AI 工具与智能体", Other: "其他" }

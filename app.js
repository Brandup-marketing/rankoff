(() => {
  ...
  function listingVisitHref(listing, position = null) {
    ...
    if (visit) go.searchParams.set("sid", visit.session_id);
    return go.toString();
  }
  ...
  function openBidDialog(trigger, listingId = null) {
    ...
    window.RankoffAcquisition?.track("review_opened");

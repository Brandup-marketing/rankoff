(() => {
  ...
  function localizeServerBoard() {
    document.querySelectorAll(".board-seo-note").forEach((node) => {
      ...
      node.textContent = `广告 · ${market ? categoryTranslations[market] : match[1]} · ${match[2]} 累计已付 · ${match[3]} 次已验证点击`;
    });
  }

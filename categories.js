(() => {
  ...
  const categoryConfig = [
    ...
    { id: "Developer", name: "Developer Tools & Infrastructure", zh: "开发者工具与基础设施", icon: "⌘" },
    { id: "Business", name: "Business & Finance", zh: "商业与金融", icon: "◌" },
    { id: "Agencies", name: "Agencies & Services", zh: "代理机构与服务", icon: "◎" },
    { id: "Ecommerce", name: "Ecommerce & Retail", zh: "电商与零售", icon: "□" },
    { id: "Productivity", name: "Productivity & Collaboration", zh: "效率与协作", icon: "＋" },

...
const files = [
  ...
  'theme-boot.js', 'meta-pixel.js', 'locale-boot.js', 'locale.js', 'locale.css', 'ms-copy.js', 'ms-legal.js', 'ms-answers.js', 'support.js', 'acquisition.js', 'currency.js', 'app.js', 'search.js', 'share.js', 'share-card.js', 'categories.js', 'about.js', 'listing.js', 'legal.js', 'admin.js', '_headers', '_routes.json',

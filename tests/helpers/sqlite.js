...
export function testDatabase() {
  ...
  for (const name of ['0001_production_core', '0003_bid_terms_consent', '0004_buyer_contact', '0005_listing_share_cards', '0006_ranking_currency', '0007_acquisition', '0008_social_publishing']) {

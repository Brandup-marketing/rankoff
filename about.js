(() => {
  ...
  const translations = new Map([
    ...
    ["RANKOFF is the public market for visible attention. Products bid for sponsored rank, show what they do, and stay in position until someone pays more. One board, one clear rule: the highest total paid takes #1.", "RANKOFF 是公开的注意力市场。产品通过竞价获得赞助排名，展示自身价值，并保持位置，直到有人出价更高。一个榜单，一条清晰规则：累计付款最高者登上第 1 名。"],

...
const ABOUT_STATIC_COPY = Object.freeze({
  ...
  Then: "随后", "Compete in public": "公开竞争", "Your public identity, description, settled total, and position appear on the board after payment settles.": "付款结算后，你的公开身份、介绍、已结算累计金额和位置会显示在榜单上。",

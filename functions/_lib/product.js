...
const PRODUCT_COPY = Object.freeze({
  en: Object.freeze({
    ...
    rule: "Highest total takes #1", claimNumberOne: "Claim #1 for", startClaim: "Challenge this rank", footerParent: "A Brandup Marketing product",
  ...
  zh: Object.freeze({
    ...
    rule: "累计出价最高者获得第 1 名", claimNumberOne: "以此价格争夺第 1 名", startClaim: "挑战此排名", footerParent: "Brandup Marketing 旗下产品",
